...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  7 13:09:29 2022
...
model.save('VOC_exception.h5', include_optimizer=True)
model.save_weights('VOC_exception_weights.h5')
test_score = model.evaluat_generator(test_set, batch_size)
