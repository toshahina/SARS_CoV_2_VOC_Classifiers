...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  7 12:58:21 2022
...
model.save('VOC_mobilenet.h5', include_optimizer=True)

model.save_weights('VOC_mobilenet_weights.h5')
...
def plot_confusion_matrix(cm, classes, normalize=False, title='Confusion matrix', cmap=plt.cm.Blues):
    ...
    fig.tight_layout()
    plt.savefig('/home/shahina/Documents/ML/VOC/dataset3/mobilenet/Confusion Matrix_5000_{}_{}'.format(batch_size,epochs))
    return ax
